...
export default function Background(){
    return(
         ...
         <div className="w-full  relative overflow-x-hidden overflow-hidden h-[900px] shadow-2xl py-12">
            {/* Background design */}
    <div className="rounded-lg sm:absolute z-0 sm:bg-[#BA9C84] sm:w-[1000px] sm:h-[1000px] sm:flex  sm:justify-items-end sm:origin-top-left sm:rotate-[25deg] sm:right-[-740px] sm:top-[-150px] sm:overflow-hidden "></div>
 <div className=" flex sm:justify-between sm:flex-row flex-col sm:mx-[10%] mx-[10px] sm:mt-[50px] mt-0">
    <div className="sm:w-[40%] w-full sm:mt-10 mt-5 text-primary " data-aos="fade-right">
...
Ut Enim Ad Minim Veniam, Quis Nostrud  
    ...
    <Button className="my-10 bg-[#265073] " data-aos="fade-up">Explore </Button>
