...
//       data-aos="zoom-in-up"
//     >
//       <h1 className="text-5xl font-serif font-bold text-[#6d433d] mb-6 mr-14">
//         Book Collections
//       </h1>
...
//       </p>
//       <p className="font-serif text-2xl text-gray-500">
//         contemporary bestsellers across.
//       </p>
...
//           <div
//             key={index}
//             className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-44"
//           >
