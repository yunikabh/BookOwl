    ...
    <div className="space-y-8 p-4">
      {bookGroups.map((group, index) => (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 cursor-pointer">
            {group.map((book) => (
               <Link key={group} href="/pages/bookpage">
              <div key={book.id} className="flex flex-col items-center bg-white rounded-lg shadow">
                <img
                ...
                <div className="p-4 text-center">
                  ...
                  <p className="text-sm font-semibold text-gray-700">{book.price}</p>
                </div>
              </div>
              </Link>
            ))}
