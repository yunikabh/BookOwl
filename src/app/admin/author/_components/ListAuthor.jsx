...
export default function ListAuthor({ data }) {
              ...
              <TableRow key={items._id}>
                <TableCell>
                  <div className="rounded-lg w-20 h-20 overflow-hidden">
                    <img
                      src={
                        items?.authorImage && items.authorImage.trim() !== ""
                          ? items.authorImage.replace(/\\/g, "/")
                ...
                <TableCell>{items.authorBio}</TableCell>
                <TableCell>{items.moreBooks}</TableCell>
